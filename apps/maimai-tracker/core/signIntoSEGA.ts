...
export const signIntoSEGA = async (browser: Browser) => {  // entrypoint
  console.log('entry')
  ...
  await page.waitForSelector('body > div.wrapper.main_wrapper.t_c > div.see_through_block.m_15.m_t_0.p_10.p_r.t_l.f_0 > div.basic_block.p_10.p_b_5.f_0 > img')
  await page.close()
}